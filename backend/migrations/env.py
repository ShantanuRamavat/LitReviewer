...
# Import Base to register all ORM models via their metadata.
from app.db.postgres.engine import Base  # noqa: F401
import app.db.models  # noqa: F401 — side-effect: registers all mapped classes
